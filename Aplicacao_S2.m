...
r = 0.14; % raio de influencia de um cluster
epsilon = 0.4; % Fator de raio de cluster
m = 2; %Ponderamento exponencial para calculo de pertinencias 2.8
gama = 0.5; % Ponderamento das informacoes no potencial 0.775
s = 0.96; % Fator de sensibilidade para determinacao de candidato 0.81
