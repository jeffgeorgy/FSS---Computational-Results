...
max_u = 18; min_u = 2; % Valor maximo e minimo da entrada para normalizacao
max_y = 18; min_y = 2; % Valor maximo e minimo da saida para normalizacao
...
r = 0.4; % raio de influencia de um cluster
epsilon = 0.15; % Fator de raio de cluster
m = 2; %Ponderamento exponencial para calculo de pertinencias 2.8
gama = 0.575; % Ponderamento das informacoes no potencial 0.775
