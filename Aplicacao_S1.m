...
% Inicializa a contagem de tempo 0.24 0.265 2 0.15 0.93
...
gama = 0.15; % Ponderamento das informacoes no potencial 0.775
...
ylabel('Coordinate 2')
axis equal
axis([3.75e5 6.25e5 0.35e5 2.85e5])
% mu = zeros(R,N);
% D = mu;
% for j = 1:N
%     for i = 1:R % Medicao da distancia adaptativa do dado atual para os centros
