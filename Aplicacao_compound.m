...
max_u = 45; min_u = 5; % Valor maximo e minimo da entrada para normalizacao
max_y = 24; min_y = 4; % Valor maximo e minimo da saida para normalizacao
...
r = 0.375; % raio de influencia de um cluster
epsilon = 0.5; % Fator de raio de cluster
m = 2.8; %Ponderamento exponencial para calculo de pertinencias 2.8
gama = 0.875; % Ponderamento das informacoes no potencial 0.775
s = 0.975; % Fator de sensibilidade para determinacao de candidato 0.81
