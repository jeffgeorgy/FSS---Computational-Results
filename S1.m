...
clc
close all
dados = load('S1.txt');  % Carrega o conjunto de dados
centros = load('s1-cb.txt'); % Carrega os centros reais de clusters
...
r = 0.04; % Decaimento Gaussiano
m = 1.7; % Grau de incerteza
gama = 0.14; % Peso multivariavel
...
legend("Vexpoectors of Data","Centers of Clusters",...
    "$\mu$ = 0.9","$\mu$ = 0.7"...
