...
% 0.2 0.265 2 0.95 0.93
% 0.175 0.33 2 0.95 0.9
% Parâmetros do algoritmo
r = 0.2; % raio de influencia de um cluster
epsilon = 0.275; % Fator de raio de cluster
m = 2; %Ponderamento exponencial para calculo de pertinencias 2.8
gama = 0.95; % Ponderamento das informacoes no potencial 0.775
s = 0.93; % Fator de sensibilidade para determinacao de candidato 0.81
...
%         end
%     end
%     contour(xm,ym,Dm(:,:,l)',epsilon*r*[1,1],'r');
% end
