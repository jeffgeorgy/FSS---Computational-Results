...
load('u7.mat')
load('y7.mat'); % Carrega os dados da serie
...
r = 3; % raio de influencia de um cluster
epsilon = 0.4; % Fator de raio de cluster
m = 2; %Ponderamento exponencial para calculo de pertinencias
gama = 0.5; % Ponderamento das informacoes no potencial
s = 0.95; % Fator de sensibilidade para determinacao de candidato
