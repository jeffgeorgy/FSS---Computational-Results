...
u_ = centros(:,1);
y_ = centros(:,2);
max_u = 6e5; min_u = 1e5; % Valor maximo e minimo da entrada para normalizacao
max_y = 4.6e5; min_y = 2.6e5; % Valor maximo e minimo da saida para normalizacao
...
r = 0.2; % raio de influencia de um cluster 0.1 a 0.3
epsilon = 0.35; % Fator de raio de cluster 0.3 a 0.5
m = 2; %Ponderamento exponencial para calculo de pertinencias 2.8
gama = 0.9; % Ponderamento das informacoes no potencial 0.8 a 1
s = 0.94; % Fator de sensibilidade para determinacao de candidato 0.7 a 1
...
ylabel('Coordinate 2')
axis equal
axis([1.95e5 2.25e5 3.35e5 3.65e5])
% % Mede a partição final
